...
Projeto inicial do módulo de Back-End do curso de Desenvolvimento Web da Trybe. (Referente ao bloco 19).
...
## Restauração do banco de dados `Northwind`

 Faça o download do arquivo de backup [aqui](northwind.sql) clicando em "Raw", depois clicando com botão direito e selecionando "Salvar como" para salvar o arquivo em seu computador.
